...
from app.graph.nodes.call_general_model.sys_message import get_sys_message, general_system_message
...
async def call_model(state):
    ...
    decoded_tokenized_context = ""
    if general_system_message:
        system_message = general_system_message
    else:
        system_message = get_sys_message(decoded_tokenized_context)
    ...
    MAX_INPUT_TOKENS = 2048 # can go up to 4096
